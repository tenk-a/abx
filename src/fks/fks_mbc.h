...
fks_mbcenc_t fks_mbsAutoCharEncoding(char const* src, size_t len
                , int canEndBroken FKS_ARG_INI(0), fks_mbcenc_t *tbl FKS_ARG_INI(0), size_t tblN FKS_ARG_INI(0));
...
char*   fks_mbsConvMalloc(fks_mbcenc_t dstMbc, fks_mbcenc_t srcMbc, char const* src, size_t srcSz
                , size_t* pDstSz FKS_ARG_INI(0));


size_t  fks_mbsConvUnicode(fks_mbcenc_t dstMbc, char dst[], size_t dstSz
                , fks_mbcenc_t srcMbc, char const* src, size_t srcSz);
...
fks_mbcenc_t fks_mbsAutoCharEncoding(unsigned char const* src, size_t len, int canEndBroken FKS_ARG_INI(0), fks_mbcenc_t *tbl FKS_ARG_INI(0), size_t tblN FKS_ARG_INI(0));
