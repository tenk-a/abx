...
#define FKS_RANGE_I_ASSERT(x,a,b)                                           \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                ...
                ,__FILE__,__LINE__,FKS_M_FUNC,#x,(int)(x)                   \
                , (int)(a),(int)(b) )) )
...
#define FKS_RANGE_L_ASSERT(x,a,b)                                           \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                ...
                , __FILE__,__LINE__,FKS_M_FUNC,#x, (long)(x)                \
                , (long)(a), (long)(b) )) )
...
#define FKS_RANGE_U_ASSERT(x,a,b)                                           \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF(("%s (%d) %s: %s, out of range[%#x, %#x].\n"   \
                ,__FILE__,__LINE__,FKS_M_FUNC,#x, (unsigned)(x)             \
...
#define FKS_RANGE_F_ASSERT(x,a,b)                                           \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                ...
                ,__FILE__,__LINE__,FKS_M_FUNC,#x,(float)(x)                 \
                , (float)(a), (float)(b) )) )
...
#define FKS_RANGE_D_ASSERT(x,a,b)                                           \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                "%s (%d) %s: %s (%g), out of range[%g, %g].\n"              \
                ,__FILE__,__LINE__,FKS_M_FUNC,#x,(double)(x)                \
                , (double)(a), (double)(b) )) )
...
#define FKS_ARG_RANGE_I_ASSERT(n,x,a,b)                                     \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                "%s (%d) %s: %s (%d), out of range[%d, %d].\n"              \
                ,__FILE__,__LINE__,FKS_M_FUNC,(n),#x,(int)(x)               \
                , (int)(a),(int)(b) )) )
...
#define FKS_ARG_RANGE_L_ASSERT(n,x,a,b)                                     \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                 "%s (%d) %s: %s (%ld), out of range[%ld, %ld].\n"          \
                ,__FILE__,__LINE__,FKS_M_FUNC,(n),#x, (long)(x)             \
                , (long)(a), (long)(b) )) )
...
#define FKS_ARG_RANGE_UI_ASSERT(n,x,a,b)                                    \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF(("%s (%d) %s: %s, out of range[%#x, %#x].\n"   \
                ,__FILE__,__LINE__,FKS_M_FUNC,(n),#x, (unsigned)(x)         \
                , (unsigned)(a), (unsigned)(b) )) )

#define FKS_ARG_RANGE_UL_ASSERT(n,x,a,b)                                    \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF(("%s (%d) %s: %s, out of range[%#lx, %#lx].\n" \
                ,__FILE__,__LINE__,FKS_M_FUNC,(n),#x, (FKS_ULONG)(x)        \
                , (FKS_ULONG)(a), (FKS_ULONG)(b))))
...
#define FKS_ARG_RANGE_F_ASSERT(n,x,a,b)                                     \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                 "%s (%d) %s: %s (%g), out of range[%g, %g].\n"             \
                ,__FILE__,__LINE__,FKS_M_FUNC,(n),#x,(float)(x)             \
                , (float)(a), (float)(b) )) )
...
#define FKS_ARG_RANGE_D_ASSERT(n,x,a,b)                                     \
        ( ((a) <= (x) && (x) <= (b))                                        \
         || FKS_ABORT_PRINTF((                                              \
                "%s (%d) %s: %s (%g), out of range[%g, %g].\n"              \
                ,__FILE__,__LINE__,FKS_M_FUNC,(n),#x,(double)(x)            \
                , (double)(a), (double)(b) )) )
